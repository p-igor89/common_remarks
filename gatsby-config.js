...
const siteMetadata = {
  ...
  description:
    'Reflections on work, life, and learning from an engineer’s perspective. ' +
    'Posts on automation, performance, productivity, and the occasional life detour.',
  keywords: 'blog, automation, performance, software engineering, productivity, life, reflections',
  ...
  siteUrl: process.env.GATSBY_DOMAIN || 'https://commonremarks.dev',
  lang: 'en-US',
  brand: '#f0ff7b',
  author: {
    name: 'Ihor Peretiatko',
    twitter: 'p_ihor89',
    url: 'https://x.com/p_ihor89',
  },
};
      ...
      options: {
        plugins: [
          ...
          },
          {
            ...
            options: {
              prefix: '',
              suffix: '?utm_source=commonremarks.dev&utm_medium=link',
            },
          },
          {
